...
- __Advanced Maintenance Functions__:
    ...
    - Clean Nozzles: Performs a standard cleaning cycle on the selected nozzle group.

    - Power Clean of the nozzles: Uses a higher quantity of ink to perform a deeper cleaning cycle. Power cleaning also consumes more ink and fills the waste ink tank more quickly. It should only be used when normal cleaning is insufficient.
...
See `self.printer.check_nozzles()` and `self.printer.clean_nozzles(0)` for examples of usage of remote commands.
